...
;
;	4) Timer 0 Interrupt Rate: 8.192ms
;
; To-Do List:
...
start0		;Main Program Loop
	...
	btfss 	editpb
	bra		start1
	call	reset_counter	;Reset counters if button was pressed
	btg		editable
	bcf		editpb
start1
	btfsc 	editable	
...
;	Sleep mode currently disabled. Uncomment following 2 lines to enable sleep mode
;	btfsc	onesec
